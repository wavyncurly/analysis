---
layout: page
title: The Exploration of Musicians in Alexandria<!--- insert title --->
author: ChristianRagland
image: title: content-images/Pie Chart.png
...
#Pursuing the Question in a Useful Manor#
   ...
   by using an Xpath query for “//div[@type=”item”][contains(.,’band’)].”  This proved to not be the most
	...
	The discovery brought me to the realization that creating a logical way to retrieve the origin of the bands
